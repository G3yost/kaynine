    ...
    if( level.length === 0){
        ...
        for(i = 0; i < level.length; i++) {
            ...
            switch(level.charAt(i)) {
                ...
                case('['):
                    var RT = new Turret(game, ASSET_MANAGER.getAsset("img/turret_right.png"), x, y, 50, 100, true,  cam);
                    game.addEntity(RT);
                    break;      // Right Facing Turret

                case(']'):
                    var LT = new Turret(game, ASSET_MANAGER.getAsset("img/turret_left.png"), x, y, 50, 100, false,  cam);
                    game.addEntity(LT);
